...
#define LrdOutputViewBackgroundColor [UIColor colorWithWhite:0.2 alpha:1]
#define  LrdOutputViewTextColor [UIColor whiteColor]

CGFloat const LeftToView = 10.0;
CGFloat const TopToView = 10.0;

NSString *const LrdOutputViewIdentifier = @"LrdOutputViewIdentifier"; // 重用
...
- (instancetype)initWithDataArray:(NSArray *)dataArray
    ...
    if (self = [super initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)]) {
        ...
        _tableView.backgroundColor = LrdOutputViewBackgroundColor;
        ...
        //注册cell
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:LrdOutputViewIdentifier];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:LrdOutputViewIdentifier];
    cell.textLabel.textColor = LrdOutputViewTextColor;
